...
dict_params["leading_ankle_to_com_txt"] = 1           # Show max. distance between the leading ankle and the center of mass (com) relative to leg length.
dict_params["trailing_ankle_to_com_txt"] = 1          # Show max. distance between the trailing ankle and the center of mass (com) relative to leg length.
